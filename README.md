...
```bash
stepfunctions-aliases$ sam build
```
...
```bash
stepfunctions-aliases$ sam logs -n StockCheckerFunction --stack-name stepfunctions-aliases --tail
```
...
```bash
stepfunctions-aliases$ go test -v ./functions/...
```
...
```bash
sam delete --stack-name stepfunctions-aliases
```
